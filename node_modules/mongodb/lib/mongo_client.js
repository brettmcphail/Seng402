...
function MongoClient() {
   ...
   * @param {object} [options.public=null] A hash of options to set on the public objects, see **Server** constructor**
...
MongoClient.connect = function(url, options, callback) {
  ...
  // Set default empty public options
  ...
  // Merge in any options for public in options object
  if(serverOptions) {
    for(var name in serverOptions) object.server_options[name] = serverOptions[name];
  }

  // Merge in any replicaset public options
  ...
  // If we have more than a public, it could be replicaset or mongos list
    ...
    var connectFunction = function(__server) { 
      ...
      new Db(object.dbName, __server, {w:1, native_parser:false}).open(function(err, db) {
        ...
        if(!err) {
          ...
          // Check what type of public we have
