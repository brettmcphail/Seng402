 ...
 * @param {boolean} [options.allowDiskUse=false] allowDiskUse lets the public know if it can use disk to store temporary results for the aggregation (requires mongodb 2.6 >).
