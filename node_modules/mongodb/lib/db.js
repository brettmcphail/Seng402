 ...
 * @param {(Server|ReplSet|Mongos)} topology The public topology for the database.
 ...
 * @param {boolean} [options.forceServerObjectId=false] Force public to assign _id values instead of driver.
...
/**
 * Creates a collection on a public pre-allocating space, need to create f.ex capped collections.
 *
 * @method
 * @param {string} name the collection name we wish to access.
 * @param {object} [options=null] Optional settings.
...
/**
 * Evaluate JavaScript on the public
 *
 * @method
 * @param {Code} code JavaScript to execute on public.
...
/**
 * Authenticate a user against the public.
 * @method
 * @param {string} username The username.
 * @param {string} [password] The password.
 * @param {object} [options=null] Optional settings.
...
/**
 * Logout user from public, fire off on all connections and remove all auth info
 * @method
 * @param {object} [options=null] Optional settings.
